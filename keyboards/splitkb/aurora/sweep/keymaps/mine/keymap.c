...
#define WIND_N A(KC_TAB)
#define WIND_P A(S(KC_TAB))
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NAV] = LAYOUT(
        _______, _______, KC_TAB,  KC_ESC,  A(KC_F4),    TAB_P,   WIND_P,  WIND_N,  TAB_N,   KC_DEL,
        OS_SUPR, OS_ALT,  OS_CTRL, OS_SHFT, _______,     KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_BSPC,
